...
let versioning_configuration: VersioningConfiguration = http::take_body_literal::<VersioningConfiguration>(req, "Enabled")?;
...
let object_lock_configuration: Option<ObjectLockConfiguration> = http::take_opt_body_literal::<ObjectLockConfiguration>(req, "Enabled")?;
